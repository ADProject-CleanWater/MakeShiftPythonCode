...
class Main(QDialog):
    ...
    def draw_graph(self):
        if self.key == 'temp':
            ...
            self.sc.axes.cla()
            self.sc.axes.plot(getListDB.sortedListDB_X("개월"), getListDB.sortedListDB_Y("temp 평균"), color='red')
            self.sc.axes.plot(getListDB.sortedListDB_X("개월"), getListDB.sortedListDB_Y("humi 평균"), color='blue')
